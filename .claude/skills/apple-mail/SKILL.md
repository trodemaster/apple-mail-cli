---
name: apple-mail
description: Read and manage Apple Mail.app — list accounts, browse mailboxes, list/read/search messages, send email, and manage filter rules. Use when the user asks about their email, wants to read or find messages, check unread mail, send an email, route a domain to a folder, or anything related to Mail.app or email on macOS.
